...
export BLACK=0xff181819
export WHITE=0xffe2e2e3
export RED=0xffff5c57
export GREEN=0xff5af78e
export BLUE=0xff57c7ff
export YELLOW=0xfff3f99d
export ORANGE=0xffff9f43
export MAGENTA=0xffff6ac1
export GREY=0xffe2e4e5
export TRANSPARENT=0x00000000
export BG0=0xff2c2e34
export BG1=0xff363944
export BG2=0xff414550
...
export BAR_BORDER_COLOR=$TRANSPARENTs
